...
from tensorflow.keras.layers import Input, Dropout, Dense, LSTM, MultiHeadAttention
...
class SwinTransformerBlock(layers.Layer):
    def __init__(self, embed_dim, window_size, num_heads):
        ...
        # Feed-forward 网络
        self.ffn = tf.keras.Sequential([layers.Dense(embed_dim * 4, activation='relu'),
...
# 定义模型
def build_model(input_shape=(6000, 1), num_classes=10, embed_dim=32, window_size=4, num_heads=2):
